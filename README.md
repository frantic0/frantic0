...
- [**sema-engine**](https://github.com/frantic0/sema-engine) — a C++/Wasm/JavaScript signal engine for live code language ecosystems and modern web audio applications
